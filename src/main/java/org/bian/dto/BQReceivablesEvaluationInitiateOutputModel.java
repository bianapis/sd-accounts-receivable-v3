...
/**
 * BQReceivablesEvaluationInitiateOutputModel
 */
public class BQReceivablesEvaluationInitiateOutputModel   {
  ...
  private String receivablesEvaluationInitiateActionReference = null;
  ...
  **/
   ...
   * @return receivablesEvaluationInitiateActionReference
  **/

  public String getReceivablesEvaluationInitiateActionReference() {
    return receivablesEvaluationInitiateActionReference;
  }

  public void setReceivablesEvaluationInitiateActionReference(String receivablesEvaluationInitiateActionReference) {
    this.receivablesEvaluationInitiateActionReference = receivablesEvaluationInitiateActionReference;
  }
  ...
  **/
  ...
  /**
   * `status: Not Mapped`  core-data-type-reference: BIAN::DataTypesLibrary::CoreDataTypes::UNCEFACT::Text  general-info: The status of the Receivables Evaluation instance (e.g. initialised, pending, active) 
