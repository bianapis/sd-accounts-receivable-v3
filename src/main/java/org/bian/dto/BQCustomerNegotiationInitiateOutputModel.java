...
/**
 * BQCustomerNegotiationInitiateOutputModel
 */
public class BQCustomerNegotiationInitiateOutputModel   {
  private String customerNegotiationInstanceReference = null;

  private String customerNegotiationInitiateActionReference = null;

  private Object customerNegotiationInitiateActionRecord = null;

  private String customerNegotiationInstanceStatus = null;
  ...
  /**
   * `status: Not Mapped`  core-data-type-reference: BIAN::DataTypesLibrary::CoreDataTypes::ISO20022andUNCEFACT::Identifier  general-info: Reference to the Customer Negotiation instance 
   * @return customerNegotiationInstanceReference
  **/

  public String getCustomerNegotiationInstanceReference() {
    return customerNegotiationInstanceReference;
  }

  public void setCustomerNegotiationInstanceReference(String customerNegotiationInstanceReference) {
    this.customerNegotiationInstanceReference = customerNegotiationInstanceReference;
  }


  /**
   * `status: Not Mapped`  core-data-type-reference: BIAN::DataTypesLibrary::CoreDataTypes::ISO20022andUNCEFACT::Identifier  general-info: Reference to an Initiate service call 
   * @return customerNegotiationInitiateActionReference
  **/

  public String getCustomerNegotiationInitiateActionReference() {
    return customerNegotiationInitiateActionReference;
  }

  public void setCustomerNegotiationInitiateActionReference(String customerNegotiationInitiateActionReference) {
    this.customerNegotiationInitiateActionReference = customerNegotiationInitiateActionReference;
  }
  ...
  **/
  ...
  /**
   * `status: Not Mapped`  core-data-type-reference: BIAN::DataTypesLibrary::CoreDataTypes::UNCEFACT::Text  general-info: The status of the Customer Negotiation instance (e.g. initialised, pending, active) 
   * @return customerNegotiationInstanceStatus
  **/

  public String getCustomerNegotiationInstanceStatus() {
    return customerNegotiationInstanceStatus;
  }

  public void setCustomerNegotiationInstanceStatus(String customerNegotiationInstanceStatus) {
    this.customerNegotiationInstanceStatus = customerNegotiationInstanceStatus;
  }
