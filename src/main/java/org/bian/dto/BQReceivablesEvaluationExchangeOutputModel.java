...
/**
 * BQReceivablesEvaluationExchangeOutputModel
 */
public class BQReceivablesEvaluationExchangeOutputModel   {
  ...
  private String receivablesEvaluationExchangeActionTaskReference = null;

  private Object receivablesEvaluationExchangeActionTaskRecord = null;

  private String receivablesEvaluationExchangeActionResponse = null;

  private String receivablesEvaluationInstanceStatus = null;
  ...
  **/
  ...
  /**
   * `status: Not Mapped`  core-data-type-reference: BIAN::DataTypesLibrary::CoreDataTypes::ISO20022andUNCEFACT::Identifier  general-info: Reference to a Receivables Evaluation instance exchange service call 
   * @return receivablesEvaluationExchangeActionTaskReference
  **/

  public String getReceivablesEvaluationExchangeActionTaskReference() {
    return receivablesEvaluationExchangeActionTaskReference;
  }

  public void setReceivablesEvaluationExchangeActionTaskReference(String receivablesEvaluationExchangeActionTaskReference) {
    this.receivablesEvaluationExchangeActionTaskReference = receivablesEvaluationExchangeActionTaskReference;
  }


  /**
   * `status: Not Mapped`  core-data-type-reference: BIAN::DataTypesLibrary::CoreDataTypes::UNCEFACT::Binary  general-info: The exchange service call consolidated processing record 
   * @return receivablesEvaluationExchangeActionTaskRecord
  **/

  public Object getReceivablesEvaluationExchangeActionTaskRecord() {
    return receivablesEvaluationExchangeActionTaskRecord;
  }

  public void setReceivablesEvaluationExchangeActionTaskRecord(Object receivablesEvaluationExchangeActionTaskRecord) {
    this.receivablesEvaluationExchangeActionTaskRecord = receivablesEvaluationExchangeActionTaskRecord;
  }


  /**
   * `status: Not Mapped`  core-data-type-reference: BIAN::DataTypesLibrary::CoreDataTypes::UNCEFACT::Text  general-info: Details of the exchange action service response 
   * @return receivablesEvaluationExchangeActionResponse
  **/

  public String getReceivablesEvaluationExchangeActionResponse() {
    return receivablesEvaluationExchangeActionResponse;
  }

  public void setReceivablesEvaluationExchangeActionResponse(String receivablesEvaluationExchangeActionResponse) {
    this.receivablesEvaluationExchangeActionResponse = receivablesEvaluationExchangeActionResponse;
  }


  /**
   * `status: Not Mapped`  core-data-type-reference: BIAN::DataTypesLibrary::CoreDataTypes::UNCEFACT::Text  general-info: The status of the Receivables Evaluation instance (e.g. accepted, rejected, verified) 
   * @return receivablesEvaluationInstanceStatus
  **/

  public String getReceivablesEvaluationInstanceStatus() {
    return receivablesEvaluationInstanceStatus;
  }

  public void setReceivablesEvaluationInstanceStatus(String receivablesEvaluationInstanceStatus) {
    this.receivablesEvaluationInstanceStatus = receivablesEvaluationInstanceStatus;
  }
