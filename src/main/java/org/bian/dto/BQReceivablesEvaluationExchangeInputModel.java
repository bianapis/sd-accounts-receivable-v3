...
/**
 * BQReceivablesEvaluationExchangeInputModel
 */
public class BQReceivablesEvaluationExchangeInputModel   {
  ...
  private String receivablesEvaluationInstanceReference = null;

  private Object receivablesEvaluationExchangeActionTaskRecord = null;

  private CRAccountsReceivableProcedureExchangeInputModelAccountsReceivableProcedureExchangeActionRequest receivablesEvaluationExchangeActionRequest = null;
  ...
  **/
  ...
  /**
   * `status: Not Mapped`  core-data-type-reference: BIAN::DataTypesLibrary::CoreDataTypes::ISO20022andUNCEFACT::Identifier  general-info: Reference to the Receivables Evaluation instance 
   * @return receivablesEvaluationInstanceReference
  **/

  public String getReceivablesEvaluationInstanceReference() {
    return receivablesEvaluationInstanceReference;
  }

  public void setReceivablesEvaluationInstanceReference(String receivablesEvaluationInstanceReference) {
    this.receivablesEvaluationInstanceReference = receivablesEvaluationInstanceReference;
  }
  ...
  **/
  ...
  /**
   * Get receivablesEvaluationExchangeActionRequest
   * @return receivablesEvaluationExchangeActionRequest
  **/

  public CRAccountsReceivableProcedureExchangeInputModelAccountsReceivableProcedureExchangeActionRequest getReceivablesEvaluationExchangeActionRequest() {
    return receivablesEvaluationExchangeActionRequest;
  }

  public void setReceivablesEvaluationExchangeActionRequest(CRAccountsReceivableProcedureExchangeInputModelAccountsReceivableProcedureExchangeActionRequest receivablesEvaluationExchangeActionRequest) {
    this.receivablesEvaluationExchangeActionRequest = receivablesEvaluationExchangeActionRequest;
  }
